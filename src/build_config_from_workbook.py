...
def main() -> None:
    ...
    config = {
        ...
        "global_constraints": [
            "Stage 1 is 0-to-0.5 script-to-prompt generation: read the story script and generate an initial shot plan, image prompts, and video prompts.",
            "Stage 2 is 0.5-to-1 refinement: read existing draft prompts, reference images, generated clips, and iteration notes; then call local Ollama API for refinement-oriented structuring.",
            ...
            "Do not overwrite or replace existing reference images or selected video clips during prompt generation.",
